/**
 * Original Python code retrieved from hammadshakeelai/safetynet2
 * Commit: 3088d128ae99c145c5e11185b44950cb221d599d
 * File: vscode/tictactoe.py/finalized.py
 */

export const PYTHON_TICTACTOE_CODE = `def print_octothrope(one,two,three,four,five,six,seven,eight,nine):
    print("       *       *      ","\\n","   ",one,"   *   ",two,"   *   ",three,"   ","\\n","       *       *      ","\\n","* * * * * * * * * * * *","\\n","       *       *      ","\\n","   ",four,"   *   ",five,"   *   ",six,"   ","\\n","       *       *      ","\\n","* * * * * * * * * * * *","\\n","       *       *      ","\\n","   ",seven,"   *   ",eight,"   *   ",nine,"   ","\\n","       *       *      ",sep="")
def main():
